...
const emailjs_imap_client_1 = require("emailjs-imap-client");
const events_1 = require("events");
const config_1 = require("./config");
const jsome = require("jsome");
class IMAPContainer extends events_1.EventEmitter {
    /**
     *
     */
    constructor() {
        super();
        const cfg = config_1.default.getConfig();
        this.client = new emailjs_imap_client_1.default(cfg.getServer(), 993, {
            auth: {
